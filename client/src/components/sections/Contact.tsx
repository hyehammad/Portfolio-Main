    ...
    <section id="contact" className="py-40 relative min-h-screen flex items-center justify-center overflow-hidden px-8">
      <div className="container mx-auto max-w-4xl relative z-10 text-center">
        ...
        >
          ...
          <div className="space-y-8">
            ...
            >
              <div className="flex flex-col md:flex-row items-center justify-between gap-6 w-full">
                ...
                <motion.button
                  onClick={() => {
                    const mailtoLink = `mailto:hamad.akram70@gmail.com?subject=Portfolio Inquiry`;
            ...
            >
              <div className="flex flex-col md:flex-row items-center justify-between gap-6 w-full">
                ...
                <motion.a
                  ...
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="px-8 py-3 bg-white/10 text-white font-medium rounded-lg hover:bg-white/20 transition-colors flex items-center gap-2 whitespace-nowrap font-sans border border-white/20"
                >
          ...
          {/* Footer Contact Info - Kept same as original */}
